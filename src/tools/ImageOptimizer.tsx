            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['image/webp', 'image/jpeg', 'image/png'].map((fmt) => (
                      <Button
                        key={fmt}
                        variant={settings.format === fmt ? 'primary' : 'secondary'}
                        size="sm"
                        onClick={() => setSettings(s => ({ ...s, format: fmt as any }))}
                        className={settings.format !== fmt ? 'bg-slate-100 text-slate-600 border-transparent' : ''}
                      >
                ...
                <RangeControl
                  ...
                  onChange={(val) => setSettings(s => ({ ...s, quality: val / 100 }))}
                  min={10}
                  max={100}
                  step={5}
                  unit="%"
                ...
                <RangeControl
                  ...
                  onChange={(val) => setSettings(s => ({ ...s, scale: val / 100 }))}
                  min={10}
                  max={100}
                  step={10}
                  unit="%"
